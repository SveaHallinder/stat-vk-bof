  ...
  const overlay = useMemo(() => {
    ...
    const highlightStyle: React.CSSProperties | undefined = targetRect
      ? {
          ...
          borderRadius: '10px',
          boxShadow: '0 0 0 9999px rgba(0, 0, 0, 0), 0 0 0 2px rgba(23,105,76,0.9)',
          pointerEvents: 'none',
    ...
    return (
      <div className="fixed inset-0 z-[9999]">
        ...
        >
          ...
          <div className="text-lg font-semibold text-[#17694c]">{step.title}</div>
          ...
          <div className="mt-4 flex flex-wrap gap-2 justify-end">
            ...
            {stepIndex < steps.length - 1 ? (
              <Button variant="default" className="bg-[#17694c] hover:bg-[#145c41]" onClick={next}>Nästa</Button>
            ) : (
              <Button variant="default" className="bg-[#17694c] hover:bg-[#145c41]" onClick={complete}>Avsluta</Button>
            )}
          </div>
        </div>
