...
- **Backup**: Daglig backup av databas
- **Monitoring**: Loggning av alla åtkomster
- **Rate limiting**: Skydda mot DDoS-attacker

## 🌐 DOMÄN & NÄTVERK

- **Huvuddomän**: app.vallentuna.se (eller liknande)
- **Admin-domän**: admin.vallentuna.se (valfritt)
